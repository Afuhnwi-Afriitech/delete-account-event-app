    ...
    >
      ...
      >
        ...
        <p style={{ color: "#1a1a1a" }}>
          ...
          email address linked to your account to one of the addresses
          below.
        </p>
        ...
        <h2 style={{ fontSize: 20, marginTop: 32, color: "#1a1a1a" }}>
          What to include
        </h2>
        ...
        <p style={{ color: "#1a1a1a" }}>
          ...
          registration and event participation data, networking/chat
          history, and push notification tokens, except where we are
          required to retain certain information to comply with legal
        ...
        <p style={{ marginTop: 32, color: "#555", fontSize: 14 }}>
          ...
          <a
            href="https://privacy-policy-steel-rho.vercel.app"
            style={{ color: "#2563eb" }}
          >
            Privacy Policy
          </a>
